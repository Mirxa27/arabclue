...
>
    <div
        class="lqd-navbar-inner group/navbar-inner -me-navbar-me h-full justify-between gap-2 overflow-y-auto overscroll-contain pe-navbar-pe ps-navbar-ps lg:group-[&.navbar-shrinked]/body:flex lg:group-[&.navbar-shrinked]/body:flex-col lg:group-[&.navbar-shrinked]/body:items-center lg:group-[&.navbar-shrinked]/body:justify-between">

        <div
            class="lqd-navbar-logo relative grid min-h-[--header-height] max-w-full items-center pe-navbar-link-pe ps-navbar-link-ps backdrop-blur group-[.navbar-shrinked]/body:w-full group-[.navbar-shrinked]/body:place-items-center group-[.navbar-shrinked]/body:justify-center group-[.navbar-shrinked]/body:px-0 group-[.navbar-shrinked]/body:text-center max-lg:hidden lg:before:content-none">
            <a
