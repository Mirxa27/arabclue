                ...
                @if (!\App\Helpers\Classes\Helper::isUserVIP() && !$marketSubscription['data'] && $item['price'] != 0 && \App\Helpers\Classes\Helper::appIsNotDemo())
                    ...
                    >
                        ...
                        <p class="mb-6 font-medium">
                            {{ trans('Premium membership unlocks full access to all ArabClue features and exclusive benefits. Stand out from the crowd at an affordable monthly rate.') }}
                        </p>
