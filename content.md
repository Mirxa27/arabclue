...
* Layout: (Card-based design for 3 properties, each with image, name, brief description, price/night if applicable, and link)
  ...
  * Property 1:
    * Image: [Image of Luxury Villa – Al Rajhi]
    * Name: Luxury Villa — Al Rajhi
    * Description: (e.g., "Spacious elegance in a prestigious neighborhood, perfect for families or groups.")
  
  * Property 2:
    * Image: [Image of Executive Apartment – Olaya]
    * Name: Executive Apartment — Olaya
    * Description: (e.g., "Sleek, modern living in the heart of the business district, ideal for professionals.")
  
  * Property 3:
    * Image: [Image of Family Home – Al Malqa]
    * Name: Family Home — Al Malqa
