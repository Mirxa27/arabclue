        ...
        >
            ...
            <x-slot:modal>
                ...
                >
                    ...
                    <div
                        class="mb-4"
                        x-show="adminInstructions && adminInstructions.trim().length > 0"
                    >
                        <label class="mb-2 block text-xs font-medium text-heading-foreground/60">
                            {{ __('Default Instructions (Set by Admin)') }}
                        </label>
                        <div
                            class="rounded-lg bg-heading-foreground/5 p-3 text-xs text-heading-foreground/70"
                            x-text="adminInstructions"
                        ></div>
                    </div>
                        ...
                        return {
                            ...
                            async loadInstructions() {
                                ...
                                try {
                                    ...
                                    if (data.success) {
                                        this.adminInstructions = data.admin_instructions || '';
