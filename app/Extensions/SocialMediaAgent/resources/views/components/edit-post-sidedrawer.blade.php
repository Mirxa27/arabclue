        ...
        <div class="max-h-[calc(100vh-4rem)] min-h-full overflow-y-auto">
            ...
            >
                <template x-if="editingPost.media_urls?.length">
                    ...
                    >
                        <template x-for="(media, index) in editingPost.media_urls">
                            <img
                        ...
                        <template x-if="editingPost.media_urls.length >= 2">
                            <div>
                                <button
                                ...
                                <div
                                    ...
                                    <template x-for="(media_url, index) in editingPost.media_urls">
                                        <button
                        ...
                        >
                            @foreach ($platforms as $platform)
                                ...
                                <div
                                    ...
                                    x-show="editingPost.platform_id != {{ $platform->id }}"
                                >
                                    <figure class="w-5 transition-all group-hover:scale-125">
                                        <img
